...
public final class BackupService {
    ...
    public static int cleanupOldBackups(int keepCount) {
        ...
        for (int i = keepCount; i < regular.size(); i++) {
            ...
            } catch (IOException e) { WaspLogger.error("Operation failed in BackupService", e);
    ...
    public static Path exportBackup(Path source, Path target) {
        ...
        try {
            ...
            WaspLogger.info("Backup exported and verified. file=" + targetPath);
            return targetPath;
        } catch (Exception e) { WaspLogger.error("Operation failed in BackupService", e);
    ...
    private static String findPerformedBy(String fileName) {
        ...
        } catch (SQLException e) { WaspLogger.error("Operation failed in BackupService", e);
            return "Not recorded";
        }
    }
